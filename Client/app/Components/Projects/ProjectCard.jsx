...
const ProjectCard = ({title, description, tags, link}) => {
  return (
    <div className="px-[5%] py-[6%] text-[4vw] bg-[#fff] border-[#121212] flex flex-col justify-around border-[0.2em] shadow-[0.5em_0.5em_0_0_#121212] mb-[10%]">
      <h3 className="text-[5vw] md:text-[2rem] mb-[4%] font-bold text-[#121212]">{title}</h3>
      <p className="text-[#555] text-[3.5vw] mb-[2%] md:text-[1.5rem]">{description}</p>

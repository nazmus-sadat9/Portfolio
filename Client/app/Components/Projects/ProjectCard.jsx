...
const ProjectCard = ({title, description, tags, link}) => {
  ...
  return (
    <div className="hoverCards w-full h-full px-[5%] py-[6%] text-[4vw] bg-[#fff] border-[#121212] flex flex-col justify-around border-[0.2em] shadow-[0.5em_0.5em_0_0_#121212] mb-[10%]">

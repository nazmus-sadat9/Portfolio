...
const Navbar = () => {
  ...
  return (
    <div className="w-screen h-auto flex justify-center items-center z-[500] text-[4vw] md:text-[2rem] fixed left-0 top-[2%]">
      <div className="px-[3%] h-auto w-[80%] max-w-2xl md:w-[100%] bg-[#ffffff] border-[#121212] border-[0.1em] rounded-[0.5em] shadow-[0.4em_0.4em_0_0_#121212] flex items-center justify-between">
